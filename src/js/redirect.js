...
var ProgressManager = (function () {
    function ProgressManager(selector) {
        this.active = false;
    ...
    ProgressManager.prototype.hide = function (on_move) {
        if (this.active) {
            this.active = false;
...
var Router = (function () {
    function Router() {
        ...
        this.load_error = function (message) {
        ...
        this.challenge = function (challenge_id) {
        ...
        this.redirect_to_url = function (pathname) {
            ...
            _this.load_error("Page not found");
        };
    }
    Router.redirect_log = function (color, messageContents, data) {
        console.colourLog("#00F", color, messageContents, data);
    };
    Router.prototype.redirect = function (page, contents, id) {
